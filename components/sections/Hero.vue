...
div(v-if="start" class="relative showcase md:h-screen")
  ...
  .video-container(v-if="video")
    video(src='https://res.cloudinary.com/aherod/video/upload/v1619879518/LORAPICAULT/IMG_1094.MP4_llwnui.mp4' autoplay="false" :playsinline="true" muted loop="loop")
