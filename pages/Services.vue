<template lang="pug">
  div(v-if="cennik")
    div.bg-auto.bg-cover.bg-no-repeat.bg-center.text-white.flex.flex-col.justify-end.mb-8(
    ...
    div(class="px-2 md:px-0 xl:container").m-auto
      section(id="services").flex.flex-col.items-center.justify-center
      ...
      section(id="eyebrows").flex.flex-col.items-center.justify-center
      ...
      section(id="packages").flex.flex-col.items-center.justify-center
      ...
      section(id="lessons").flex.flex-col.items-center.justify-center
      ...
      section(id="voucher").flex.flex-col.items-center.justify-center
      ...
      section(id="arrival").flex.flex-col.items-center.justify-center
        h2(class="text-2xl md:text-4xl font-extrabold uppercase pb-3 md:pb-6 mt-8") Dojazd
